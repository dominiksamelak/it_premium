    ...
    <div className="services-container">
      ...
      <div className="services-left">
        ...
        <div className="services-text">
          <CustomLink to="/pcfix" className="services-text-link">
      ...
      <div className="services-right">
        <div className="services-text-right">
          <CustomLink to="/phonefix" className="services-text-link">
      ...
      <div className="services-left">
        ...
        <div className="services-text">
          <CustomLink to="/printerfix" className="services-text-link">
      ...
      <div className="services-right">
        <div className="services-text-right">
          <CustomLink to="/datarecovery" className="services-text-link">
      ...
      <div className="services-left">
        ...
        <div className="services-text">
          <CustomLink to="/companiescoop" className="services-text-link">
      ...
      <div className="services-right">
        <div className="services-text-right">
          <CustomLink to="/otherfix" className="services-text-link">
